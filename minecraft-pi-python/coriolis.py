...
def con(mc,x,y,z):
	...
	mc.setBlocks(x+7, y+8, z+1, x+6, y+8, z+1, 89)
	mc.setBlocks(x+6, y+8, z+1, x+7, y+8, z+1, 89)
	mc.setBlocks(x+9, y+4, z+1, x+4, y+4, z+1, 89)
	mc.setBlocks(x+8, y+3, z+1, x+5, y+3, z+1, 89)
	mc.setBlocks(x+7, y+2, z+1, x+6, y+2, z+1, 89)
	mc.setBlocks(x+9, y+8, z+1, x+9, y+8, z+1, 89)
	mc.setBlocks(x+10, y+9, z+1, x+10, y+9, z+1, 89)
	mc.setBlocks(x+11, y+10, z+1, x+11, y+10, z+1, 89)
	mc.setBlocks(x+12, y+11, z+1, x+12, y+11, z+1, 89)
	mc.setBlocks(x+4, y+8, z+1, x+4, y+8, z+1, 89)
	mc.setBlocks(x+3, y+9, z+1, x+3, y+9, z+1, 89)
	...
	mc.setBlocks(x+-1, y+1, z+1, x+-1, y+1, z+1, 89)
	mc.setBlocks(x+-2, y+2, z+1, x+-2, y+2, z+1, 89)
